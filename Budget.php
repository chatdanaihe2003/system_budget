...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['action']) && $_POST['action'] == 'add') {
        $stmt = $conn->prepare("INSERT INTO budget_status_changes (change_order, doc_date, doc_no, description, change_type, amount) VALUES (?, ?, ?, ?, ?, ?)");
...
// --- ดึงข้อมูล ---
$sql_data = "SELECT * FROM budget_status_changes ORDER BY change_order ASC";
...
<body>
    ...
    <div class="navbar-custom">
        <div class="container-fluid d-flex flex-wrap">
            ...
            <div class="dropdown">
             ...
             <div class="dropdown">
                <a href="#" class="nav-link-custom dropdown-toggle <?php echo (in_array($current_page, ['Budget.php', 'Off-budget funds.php', 'National_revenue.php'])) ? 'active' : ''; ?>" data-bs-toggle="dropdown">เปลี่ยนแปลงสถานะ</a>
                <ul class="dropdown-menu">
    ...
    <div class="container-fluid pb-5 px-3">
        <div class="content-card">
            ...
            <h2 class="page-title">ทะเบียนการเปลี่ยนแปลงสถานะเงินงบประมาณ ปีงบประมาณ 2568</h2>
