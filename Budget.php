...
if (isset($_GET['delete_id'])) {
    $id = $_GET['delete_id'];
    $stmt = $conn->prepare("DELETE FROM budget_status_changes WHERE id = ?");
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['action']) && $_POST['action'] == 'add') {
        ...
        $stmt = $conn->prepare("INSERT INTO budget_status_changes (budget_year, change_order, doc_date, doc_no, description, change_type, amount) VALUES (?, ?, ?, ?, ?, ?, ?)");
        $stmt->bind_param("iissssd", $active_year, $change_order, $doc_date, $doc_no, $description, $change_type, $amount);
        $stmt->execute();
    } elseif (isset($_POST['action']) && $_POST['action'] == 'edit') {
        $id = $_POST['edit_id'];
        $stmt = $conn->prepare("UPDATE budget_status_changes SET change_order=?, doc_date=?, doc_no=?, description=?, change_type=?, amount=? WHERE id=?");
...
$sql_data = "SELECT * FROM budget_status_changes WHERE budget_year = ? ORDER BY change_order ASC";
...
<head>
    ...
    <title>ทะเบียนการเปลี่ยนแปลงสถานะเงินงบประมาณ - AMSS++</title>
...
<body>
    ...
    <div class="sub-header">ทะเบียนการเปลี่ยนแปลงสถานะเงินงบประมาณ</div>
        ...
        <div class="container-fluid d-flex flex-wrap">
            ...
            <div class="dropdown">
             ...
             <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item <?php echo ($current_page == 'Budget.php') ? 'active' : ''; ?>" href="Budget.php">เงินงบประมาณ</a></li>
    ...
    <div class="container-fluid pb-5 px-3">
        <div class="content-card">
            ...
            <h2 class="page-title">ทะเบียนการเปลี่ยนแปลงสถานะเงินงบประมาณ ปีงบประมาณ <?php echo $active_year; ?></h2>
                ...
                <table class="table table-striped table-custom">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 25%;">ลักษณะรายการ</th>
                    ...
                    <tbody>
                        ...
                        if ($result_data->num_rows > 0) {
                            while($row = $result_data->fetch_assoc()) {
                                ...
                                echo "<tr>";
                                echo "<td class='td-center'>" . $row['change_order'] . "</td>";
                                ...
                                echo "<td class='td-left'>" . $row['change_type'] . "</td>";
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header d-block">
                    <h5 class="modal-title-custom" id="modalTitle">บันทึกการเปลี่ยนแปลงสถานะ ปีงบประมาณ <?php echo $active_year; ?></h5>
                </div>
                <div class="modal-body form-yellow-bg mx-3 mb-3">
                    <form action="Budget.php" method="POST">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-2">
                                <input type="number" name="change_order" id="change_order" class="form-control form-control-sm" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="change_type" id="change_type" class="form-control form-control-sm" required>
                            </div>
                        </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body form-yellow-bg mx-3 mb-3">
                    ...
                    <div class="row mb-2">
                        <div class="col-md-3 form-label-custom">ลักษณะรายการ :</div>
                        <div class="col-md-9" id="view_change_type"></div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-md-3 form-label-custom">จำนวนเงิน :</div>
    ...
    <script>
        function openAddModal() {
            ...
            document.getElementById('modalTitle').innerHTML = 'บันทึกการเปลี่ยนแปลงสถานะ ปีงบประมาณ <?php echo $active_year; ?>';
        ...
        function openEditModal(data) {
            ...
            document.getElementById('modalTitle').innerHTML = 'แก้ไข รายการ';
            
            document.getElementById('change_order').value = data.change_order;
        ...
        function openDetailModal(data) {
            ...
            document.getElementById('view_change_type').innerText = data.change_type;
