...
<body>
    ...
    <div class="navbar-custom">
        <div class="container-fluid d-flex flex-wrap">
            ...
            <div class="dropdown">
                <a href="#" class="nav-link-custom dropdown-toggle <?php echo (strpos(urldecode($current_page), 'Check the periodic financial report.php') !== false || in_array($current_page, ['Check budget allocation.php'])) ? 'active' : ''; ?>" data-bs-toggle="dropdown">ตรวจสอบ</a>
                <ul class="dropdown-menu">
