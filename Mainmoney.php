...
<head>
    ...
    <title>ประเภท(หลัก)ของเงิน - AMSS++</title>
    ...
    <style>
        ...
        /* Styles from Expensesbudget.php */
        ...
        /* Table Styles (Matching Expensesbudget.php) */
        ...
        .table-custom td { vertical-align: middle; border-color: #eee; padding: 12px; }
        
        .td-center { text-align: center; }
        .td-left { text-align: left; padding-left: 40px; font-weight: 500; }
