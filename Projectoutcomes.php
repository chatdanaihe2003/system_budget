...
if ($search != "") {
    // ถ้ามีการค้นหา ให้กรองด้วย project_code และต้องตรงกับ active_year
    $search_param = "%" . $search . "%";
...
<body>
    ...
    <div class="sub-header d-flex justify-content-between">
        <span>รายการ ผลผลิต/โครงการ</span>
                ...
                <table class="table table-hover table-custom">
                    ...
                    <tbody>
                        ...
                        if ($result_projects->num_rows > 0) {
                            ...
                            echo "<tr><td colspan='5' class='text-center py-4 text-muted'>ยังไม่มีข้อมูลผลผลิต/โครงการ ในปี $active_year</td></tr>";
                        }
                        ?>
                    </tbody>
                </table>
