...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['action']) && $_POST['action'] == 'add') {
        $stmt = $conn->prepare("INSERT INTO project_outcomes (budget_year, project_code, project_name) VALUES (?, ?, ?)");
        $stmt->bind_param("iss", $budget_year, $project_code, $project_name);
        $stmt->execute();
    } elseif (isset($_POST['action']) && $_POST['action'] == 'edit') {
        $id = $_POST['edit_id'];
        $stmt = $conn->prepare("UPDATE project_outcomes SET budget_year=?, project_code=?, project_name=? WHERE id=?");
        $stmt->bind_param("issi", $budget_year, $project_code, $project_name, $id);
        $stmt->execute();
    }
    header("Location: Projectoutcomes.php");
    exit();
...
<head>
    ...
    <title>กำหนดผลผลิตโครงการ - AMSS++</title>
...
<body>
    ...
    <div class="sub-header">รายการ ผลผลิต/โครงการ</div>
        ...
        <div class="container-fluid d-flex flex-wrap">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item <?php echo ($current_page == 'Projectoutcomes.php') ? 'active' : ''; ?>" href="Projectoutcomes.php">ผลผลิตโครงการ</a></li>
    ...
    <div class="container pb-5">
        <div class="content-card">
            ...
            <div class="info-box">
                ...
                หน้านี้ เป็นการกำหนดรหัส ชื่อโครงการ โดยใช้รหัสที่กรมบัญชีกลางกำหนดให้ในแต่ละปีงบประมาณสามารถเพิ่ม ลบ แก้ไข ได้ตามความต้องการของผู้ใช้ระบบ เช่น กรณีเพิ่มข้อมูล ให้เลือกที่ <strong>เพิ่มข้อมูล</strong>
                <br><br>
                <small class="text-muted">ให้พิมพ์เพิ่ม รหัสโครงการ, ชื่อผลผลิต/โครงการ, ตกลง ระบบก็จะทำการประมวลผลเพิ่มรายการ ผลผลิต/โครงการให้ทันที</small>
            </div>
                    ...
                    <tbody>
                        ...
                        if ($result_projects->num_rows > 0) {
                            ...
                            while($row = $result_projects->fetch_assoc()) {
                                ...
                                echo "<td class='td-center'>" . $row['project_code'] . "</td>";
                                echo "<td class='td-left'>" . $row['project_name'] . "</td>";
                            ...
                            echo "<tr><td colspan='5' class='text-center py-4 text-muted'>ยังไม่มีข้อมูลผลผลิต/โครงการ</td></tr>";
                        }
                        ?>
                    </tbody>
                </table>
    ...
    <div class="modal fade" id="addModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="Projectoutcomes.php" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="project_code" class="form-control" placeholder="รหัสจากกรมบัญชีกลาง" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label fw-bold">ชื่อผลผลิต/โครงการ</label>
                            <textarea name="project_name" class="form-control" rows="3" required></textarea>
                        </div>
                    </div>
            ...
            <div class="modal-content">
                <form action="Projectoutcomes.php" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-bold">ชื่อผลผลิต/โครงการ</label>
                            <textarea name="project_name" id="edit_project_name" class="form-control" rows="3" required></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">ยกเลิก</button>
