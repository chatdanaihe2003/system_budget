# AMSS++ Budget Control System
### ระบบบริหารจัดการและควบคุมงบประมาณ (สำนักงานเขตพื้นที่การศึกษาประถมศึกษาชลบุรี เขต 2)

AMSS++ (Web-based Application) คือระบบสารสนเทศเพื่อการบริหารจัดการงบประมาณ การเงิน และพัสดุ ถูกพัฒนาขึ้นเพื่อช่วยอำนวยความสะดวกในการบันทึก ติดตาม และตรวจสอบสถานะทางการเงินต่างๆ ภายในองค์กร ให้มีความถูกต้อง โปร่งใส และสามารถเรียกดูรายงานได้แบบ Real-time
