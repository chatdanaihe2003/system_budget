                    ...
                    <tbody>
                        ...
                        if ($result_plans->num_rows > 0) {
                            ...
                            while($row = $result_plans->fetch_assoc()) {
                                ...
                                echo "<td class='td-center'>" . $row['plan_code'] . "</td>";
                                echo "<td class='td-left'>" . $row['plan_name'] . "</td>";
                ...
                <form action="plan.php" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="plan_code" class="form-control" placeholder="เช่น 001" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label fw-bold">ชื่อแผนงาน</label>
            ...
            <div class="modal-content">
                <form action="plan.php" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-bold">รหัสแผนงาน</label>
                            <input type="text" name="plan_code" id="edit_plan_code" class="form-control" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label fw-bold">ชื่อแผนงาน</label>
