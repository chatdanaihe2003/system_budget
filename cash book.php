...
<body>
    ...
    <div class="navbar-custom">
        <div class="container-fluid d-flex flex-wrap">
            ...
            <div class="dropdown">
                <a href="#" class="nav-link-custom dropdown-toggle <?php echo (strpos(urldecode($current_page), 'cash book.php') !== false || in_array($current_page, ['Budget allocation report.php', 'Expenditure report categorized by project.php', 'Annuity register.php', 'Expenditure report categorized by budget code.php', 'Expenditure report categorized by type of.php', 'Daily cash balance report.php'])) ? 'active' : ''; ?>" data-bs-toggle="dropdown">รายงาน</a>
                <ul class="dropdown-menu">
                ...
                <table class="table table-striped table-custom">
                    ...
                    <tbody>
                        ...
                        if ($result_data->num_rows > 0) {
                            ...
                            // หมายเหตุ: ยอดรวมตรงนี้ปกติจะคำนวณจาก SUM ทั้งหมดในหน้า แต่ในที่นี้ใช้ข้อมูลจาก query ที่จำลองไว้
