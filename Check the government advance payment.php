...
if (isset($_GET['toggle_id']) && isset($_GET['type'])) {
    ...
    if ($type == 'approval') {
        ...
        $stmt = $conn->prepare("UPDATE government_advance_payments SET approval_status = ? WHERE id = ?");
        ...
        $stmt = $conn->prepare("UPDATE government_advance_payments SET payment_status = ? WHERE id = ?");
        $stmt->bind_param("si", $new_status, $id);
        $stmt->execute();
    }
...
// --- ดึงข้อมูล ---
$sql_data = "SELECT * FROM government_advance_payments ORDER BY pay_order ASC";
...
<body>
        ...
        <div class="container-fluid d-flex flex-wrap">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item active" href="Check the government advance payment.php">จ่ายเงินทดรองราชการ</a></li>
    ...
    <div class="container-fluid pb-5 px-3">
        <div class="content-card">
            ...
            <h2 class="page-title">ตรวจสอบการจ่ายเงินทดรองราชการ </h2>
