...
<head>
    ...
    <title>ประเภทรายจ่าย - AMSS++</title>
    ...
    <style>
        ...
        /* Styles reused from Sourcemoney.php */
...
<body>
    ...
    <div class="sub-header">รายการ ประเภทรายจ่าย</div>
                ...
                <form action="Expensesbudget.php" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="text" name="expense_code" class="form-control" placeholder="เช่น 110" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label fw-bold">ประเภทรายการจ่าย</label>
            ...
            <div class="modal-content">
                <form action="Expensesbudget.php" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <label class="form-label fw-bold">รหัส</label>
                            <input type="text" name="expense_code" id="edit_expense_code" class="form-control" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label fw-bold">ประเภทรายการจ่าย</label>
