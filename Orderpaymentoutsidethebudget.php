...
// *** Check Current Page for Active Menu ***
...
<head>
    ...
    <title>ทะเบียนสั่งจ่ายเงินนอกงบประมาณ - AMSS++</title>
...
<body>
    ...
    <div class="sub-header">ทะเบียนสั่งจ่ายเงินนอกงบประมาณ</div>
        ...
        <div class="container-fluid d-flex flex-wrap">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item active" href="Orderpaymentoutsidethebudget.php">สั่งจ่ายเงินนอกงบประมาณ</a></li>
    ...
    <script>
        ...
        function openEditModal(data) {
            ...
            document.getElementById('modalTitle').innerHTML = 'แก้ไข สั่งจ่ายเงินนอกงบประมาณ';
