...
$page_title = "รายงานเงินงบประมาณ - AMSS++";
$current_page = basename($_SERVER['PHP_SELF']); 
// ชื่อหน้าบนแถบสีทอง
$page_header = 'รายงานเงินงบประมาณ';
...
// ฟังก์ชันวันที่ไทยย่อ (เช็คเผื่อมีใน db.php แล้ว)
...
<style>
    ...
    .dropdown-item[href*="budget report.php"] {
...
<div class="container-fluid pb-5 px-3">
    <div class="content-card">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-3">
            <h2 class="page-title-custom">รายงานเงินงบประมาณ</h2>
        ...
        <div class="pagination-container d-flex justify-content-center align-items-center flex-wrap gap-1">
            ...
            <a href="#" class="pagination-link">13</a>
            <a href="#" class="pagination-link">14</a>
            ...
            <span class="pagination-active mx-1">27</span> 
            ...
            <table class="table table-custom">
                ...
                <tbody>
                    ...
                    if (isset($result_data) && $result_data->num_rows > 0) {
                        ...
                        echo "<td class='td-right text-success fs-6'>" . number_format($grand_receive, 2) . "</td>"; // ใช้ค่าตัวแปร
                        echo "<td class='td-right text-danger fs-6'>" . number_format($grand_pay, 2) . "</td>"; // ใช้ค่าตัวแปร
                        echo "<td class='td-right fs-6'>" . number_format($last_cash, 2) . "</td>";
                        echo "<td class='td-right fs-6'>" . number_format($last_bank, 2) . "</td>";
                        echo "<td class='td-right fs-6'>" . number_format($last_gov, 2) . "</td>";
                        echo "<td></td>";
                        echo "</tr>";
