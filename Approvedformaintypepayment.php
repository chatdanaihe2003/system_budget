...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['action']) && $_POST['action'] == 'add') {
        $stmt = $conn->prepare("INSERT INTO approved_main_payments (pay_order, doc_date, doc_no, ref_withdraw_no, ref_petition_no, description, amount, payment_type, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
        $stmt->bind_param("isssssdss", $pay_order, $doc_date, $doc_no, $ref_withdraw_no, $ref_petition_no, $description, $amount, $payment_type, $status);
        $stmt->execute();
...
// --- ดึงข้อมูล ---
$sql_data = "SELECT * FROM approved_main_payments ORDER BY pay_order ASC";
...
<head>
    ...
    <title>อนุมัติจ่ายเงิน - AMSS++</title>
...
<body>
    ...
    <div class="sub-header">อนุมัติจ่ายเงิน</div>
        ...
        <div class="container-fluid d-flex flex-wrap">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item active" href="Approvedformaintypepayment.php">อนุมัติจ่ายเงินประเภทหลัก</a></li>
    ...
    <div class="container-fluid pb-5 px-3">
        <div class="content-card">
            ...
            <h2 class="page-title">อนุมัติจ่ายเงิน ปีงบประมาณ 2568</h2>
            ...
            <div class="legend-container text-center">
                ...
                <div class="legend-item justify-content-center">
                    <div class="legend-box status-green"></div> <span>อนุมัติให้จ่ายเงินได้</span>
                </div>
                <div class="legend-item justify-content-center">
                    <div class="legend-box status-red"></div> <span>ไม่อนุมัติ</span>
                </div>
            </div>
