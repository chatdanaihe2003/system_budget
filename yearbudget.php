...
<head>
    ...
    <title>กำหนดปีงบประมาณ - AMSS++</title>
    ...
    <style>
        ...
        .table-custom td { vertical-align: middle; text-align: center; border-color: #eee; }
...
<body>
    ...
    <div class="sub-header">กำหนดปีงบประมาณ</div>
