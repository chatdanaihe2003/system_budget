...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['action']) && $_POST['action'] == 'add') {
        ...
        $stmt = $conn->prepare("INSERT INTO receive_budget (budget_year, receive_order, doc_date, doc_no, description, transaction_type, amount, file_name) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
...
$sql_data = "SELECT * FROM receive_budget WHERE budget_year = ? ORDER BY receive_order ASC";
...
<head>
    ...
    <title>ทะเบียนรับเงินงบประมาณ </title>
    ...
    <div class="container-fluid pb-5 px-4">
        <div class="content-card">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <h2 class="page-title m-0">ทะเบียนรับเงินงบประมาณ (ปีงบประมาณ <?php echo $active_year; ?>)</h2>
