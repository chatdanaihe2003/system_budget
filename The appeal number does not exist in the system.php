...
$current_page_encoded = urlencode('The appeal number does not exist in the system.php');
?>
...
<head>
    ...
    <title>ฎีกาที่ไม่มีในระบบ - AMSS++</title>
...
<body>
    ...
    <div class="sub-header">ฎีกาที่ไม่มีในระบบ</div>
    ...
    <div class="navbar-custom">
        <div class="container-fluid d-flex flex-wrap">
            ...
            <div class="dropdown">
                <a href="#" class="nav-link-custom dropdown-toggle <?php echo (strpos(urldecode($current_page), 'The appeal number does not exist in the system.php') !== false || in_array($current_page, ['Check budget allocation.php', 'Check the periodic financial report.php', 'Check main payment type.php', 'Check the government advance payment.php'])) ? 'active' : ''; ?>" data-bs-toggle="dropdown">ตรวจสอบ</a>
                <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item active" href="The appeal number does not exist in the system.php">เลขที่ฎีกาที่ไม่มีในระบบ</a></li>
    ...
    <div class="container-fluid pb-5 px-3">
        <div class="content-card">
            ...
            <h2 class="page-title">ฎีกาที่ไม่มีในระบบ ปีงบประมาณ 2568</h2>
                ...
                <table class="table table-striped table-custom">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 50%;">เลขที่ฎีกา</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php 
                        if ($result_data->num_rows > 0) {
                            while($row = $result_data->fetch_assoc()) {
                                echo "<tr>";
                                echo "<td class='td-center'>" . $row['item_order'] . "</td>";
                                echo "<td class='td-center'>" . $row['appeal_number'] . "</td>";
                                echo "</tr>";
                            }

                        } else {
                            echo "<tr><td colspan='2' class='text-center py-4 text-muted'>ไม่พบข้อมูล</td></tr>";
                        }
                        ?>
                    </tbody>
                </table>
