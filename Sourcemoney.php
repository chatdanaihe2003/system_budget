...
<head>
    ...
    <title>กำหนดแหล่งของเงิน - AMSS++</title>
    ...
    <style>
        ...
        /* Styles reused from Activity.php */
                    ...
                    <tbody>
                        ...
                        if ($result_sources->num_rows > 0) {
                            ...
                            while($row = $result_sources->fetch_assoc()) {
                                ...
                                echo "<td class='td-center'>" . $row['source_code'] . "</td>";
                                echo "<td class='td-left'>" . $row['source_name'] . "</td>";
                ...
                <form action="Sourcemoney.php" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="source_code" class="form-control" placeholder="รหัสจากกรมบัญชีกลาง" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label fw-bold">ชื่อแหล่งของเงิน</label>
            ...
            <div class="modal-content">
                <form action="Sourcemoney.php" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-bold">รหัส</label>
                            <input type="text" name="source_code" id="edit_source_code" class="form-control" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label fw-bold">ชื่อแหล่งของเงิน</label>
