...
// --- ดึงข้อมูล ---
$sql_data = "SELECT * FROM project_termination_appeals ORDER BY invoice_number ASC";
...
<head>
    ...
    <title>ตรวจสอบการเบิกตามฎีกากับการตัดยอดโครงการ - AMSS++</title>
...
<body>
    ...
    <div class="sub-header">ฎีกากับการตัดโครงการจำแนกตามใบงวด</div>
    ...
    <div class="container-fluid pb-5 px-3">
        <div class="content-card">
            ...
            <h2 class="page-title">ตรวจสอบการเบิกตามฎีกากับการตัดยอดโครงการ จำแนกตามใบงวด ปีงบประมาณ 2568</h2>
                ...
                <table class="table table-striped table-custom">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 25%;">จำนวนเงินเบิกตามฎีกา</th>
                            <th style="width: 25%;">จำนวนเงินตัดตามโครงการ</th>
                    ...
                    <tbody>
                        ...
                        if ($result_data->num_rows > 0) {
                            while($row = $result_data->fetch_assoc()) {
                                // คำนวณส่วนต่าง
                                $diff = $row['appeal_amount'] - $row['project_deduction_amount'];

                                echo "<tr>";
                                echo "<td class='td-center'>" . $row['invoice_number'] . "</td>";
                                echo "<td class='td-right'>" . number_format($row['appeal_amount'], 2) . "</td>";
                                echo "<td class='td-right'>" . number_format($row['project_deduction_amount'], 2) . "</td>";
